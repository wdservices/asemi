  ...
  return (
    <div className="min-h-screen bg-[#fafaf8] text-[#2b2b32]">
      ...
      <main className="max-w-[820px] mx-auto px-6 py-16">
        ...
        <p className="text-sm text-[#6e6e7a] mb-8">
        ...
        <div className="prose prose-zinc max-w-none space-y-8 text-sm leading-relaxed text-[#45454f]">
          <section>
            ...
            <p>
              By accessing or using the Asemi product authentication platform ("Service"), you
              agree to be bound by these Terms and Conditions. If you do not agree, do not use
              the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              Regulatory certificates (FDA, CE, NAFDAC, ISO) and Lab Certificates of Analysis
              can be uploaded per product or batch inside the manufacturer console.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              code volume increases. All payments are processed through integrated payment
              providers (Paystack, Flutterwave, or Stripe depending on region). Prices are quoted
              in the currency applicable to your registered country.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              All verification codes, QR symbols, and associated data generated through the
              Service remain the property of the registering brand. Asemi retains ownership of
              the platform, its underlying technology, and the cryptographic ledger infrastructure.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              or enters a verification code, they receive product authenticity information
              including product name, manufacturer, and verification status. Asemi does not collect
              personal data from consumers during the verification process.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Asemi provides the Service on an "as is" basis. While we employ cryptographic
              security measures, we do not guarantee the prevention of all counterfeiting
              activities. Asemi shall not be liable for any indirect, incidental, or consequential
